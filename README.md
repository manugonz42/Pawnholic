...
- 🛒 **Buy items** from customers at your pawnshop
- 💵 **Haggle** to get the best prices
- 📈 **Upgrade your shop** and unlock new categories
- 🎯 **Deal with suspicious customers** and unexpected events
- 💰 **Build your pawnshop empire**
...
![Unity](https://img.shields.io/badge/Unity-2022-000000?logo=unity)
...
See [GDD.md](./docs/GDD.md) for detailed game design.

---

## 🔗 Links

- [Play on itch.io](your-itch-io-link)
...
Project Link: [https://github.com/manugonz42/Pawnholic](https://github.com/manugonz42/Pawnholic)
